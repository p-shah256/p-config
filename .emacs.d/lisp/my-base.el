...
(dolist (hook '(prog-mode-hook conf-mode-hook))
  (add-hook hook #'my-enable-whitespace-maybe)
  (add-hook hook #'my-enable-indent-guides-maybe))
...
(autoload 'my-prog-completion-setup "my-completion" nil t)

(defun my-load-completion ()
  "Load completion support once startup has settled."
  (require 'my-completion))

(my-run-with-idle 0.2 #'my-load-completion)
